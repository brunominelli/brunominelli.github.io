from src.modules.lead.infrastructure.repositories.lead_sqlite_repository import LeadSQLiteRepository
...
from src.modules.lead.application.use_cases.update_lead_use_case import UpdateLeadUseCase
from src.modules.lead.application.use_cases.update_lead_status_use_case import UpdateLeadStatusUseCase
from src.modules.lead.application.use_cases.delete_lead_use_case import DeleteLeadUseCase

class LeadContainer:
    def __init__(self):
        self.repository = LeadSQLiteRepository()
        ...
        self.update_status = UpdateLeadStatusUseCase(repository=self.repository)
